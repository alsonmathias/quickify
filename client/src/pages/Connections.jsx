  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Tabs */}
        <div className="flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm mb-6">
          {dataArray.map((tab) => (
            <button
              key={tab.label}
        ...
        <div className="flex flex-wrap gap-6">
          {activeTabData.length === 0 ? (
            ...
            activeTabData.map((user) => (
              <div
                key={user._id}
                className="w-full sm:w-[360px] flex gap-5 p-6 bg-white shadow rounded-md"
              >
                <img
